...
/*:
 ...
 #### Simple(Switch)/Static Factory Definition:
- Creates objects without exposing the instantiation logic to the client.
- Refers to the newly created object through a common interface
 
 ![UML](StaticFactory.png)
 ...
 #### When to use the Factory Method pattern instead
 - (see the playground page DesignPatterns-FactoryMethod for an example)
...
//: ## Example (anti-pattern): Simple Factory (Also Paramatized)
...
// Also, this factory is "Paramatized" in that it takes an argument which returns the object type. This is usually best avoided since you have to change the factory class every time you add a new concrete class. This violates the "open close" principle.
